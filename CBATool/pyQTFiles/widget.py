...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.learnRateSpinBox.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        spacerItem = QtWidgets.QSpacerItem(110, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.row2Info.addItem(spacerItem)
        self.label_2 = QtWidgets.QLabel(Form)
        self.label_2.setObjectName("label_2")
        self.row2Info.addWidget(self.label_2)
        ...
        self.pushButtonRow.addItem(spacerItem1)
