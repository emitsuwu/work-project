...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.priceLabel.setLineWidth(1)
        ...
        self.row2Info.addWidget(self.spinBox)
        ...
        self.percentDecSpinBox.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
